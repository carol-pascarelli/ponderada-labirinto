  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: occupancy_grid_shape
  {
    ...
    if (size > 0) {
      cdr.serialize_array(&(ros_message.occupancy_grid_shape[0]), size);
    }
  }
  ...
  cg_interfaces::srv::GetMap_Response & ros_message)
{
  ...
  // Member: occupancy_grid_shape
  {
    ...
    if (size > 0) {
      cdr.deserialize_array(&(ros_message.occupancy_grid_shape[0]), size);
    }
  }
...
// functions for cg_interfaces::srv::GetMap_Request already declared above

// functions for cg_interfaces::srv::GetMap_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cg_interfaces
cdr_serialize(
  const cg_interfaces::srv::GetMap_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cg_interfaces::srv::GetMap_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetMap_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_GetMap_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cg_interfaces::srv::GetMap_Event;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetMap_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cg_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_GetMap_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const cg_interfaces::srv::GetMap_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cg_interfaces::srv::GetMap_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_cg_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<cg_interfaces::srv::GetMap_Event>()
{
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cg_interfaces, srv, GetMap_Event)() {
  return &cg_interfaces::srv::typesupport_fastrtps_cpp::_GetMap_Event__handle;
}
...
static const rosidl_service_type_support_t _GetMap__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cg_interfaces::srv::GetMap_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cg_interfaces::srv::GetMap_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<cg_interfaces::srv::GetMap_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<cg_interfaces::srv::GetMap>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<cg_interfaces::srv::GetMap>,
