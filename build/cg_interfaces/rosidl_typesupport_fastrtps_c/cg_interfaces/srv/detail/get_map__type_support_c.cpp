...
bool cdr_serialize_cg_interfaces__srv__GetMap_Request(
  const cg_interfaces__srv__GetMap_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_deserialize_cg_interfaces__srv__GetMap_Request(
  eprosima::fastcdr::Cdr & cdr,
  cg_interfaces__srv__GetMap_Request * ros_message)
{
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_serialize_key_cg_interfaces__srv__GetMap_Request(
  const cg_interfaces__srv__GetMap_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: structure_needs_at_least_one_member
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t get_serialized_size_key_cg_interfaces__srv__GetMap_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetMap_Request__ros_msg_type * ros_message = static_cast<const _GetMap_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t max_serialized_size_key_cg_interfaces__srv__GetMap_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cg_interfaces__srv__GetMap_Request * ros_message = static_cast<const cg_interfaces__srv__GetMap_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cg_interfaces__srv__GetMap_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cg_interfaces__srv__GetMap_Request * ros_message = static_cast<cg_interfaces__srv__GetMap_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cg_interfaces__srv__GetMap_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_serialize_cg_interfaces__srv__GetMap_Response(
  const cg_interfaces__srv__GetMap_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_deserialize_cg_interfaces__srv__GetMap_Response(
  eprosima::fastcdr::Cdr & cdr,
  cg_interfaces__srv__GetMap_Response * ros_message)
{
  // Field name: occupancy_grid_flattened
  {
    uint32_t cdrSize;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_serialize_key_cg_interfaces__srv__GetMap_Response(
  const cg_interfaces__srv__GetMap_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: occupancy_grid_flattened
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t get_serialized_size_key_cg_interfaces__srv__GetMap_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetMap_Response__ros_msg_type * ros_message = static_cast<const _GetMap_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t max_serialized_size_key_cg_interfaces__srv__GetMap_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cg_interfaces__srv__GetMap_Response * ros_message = static_cast<const cg_interfaces__srv__GetMap_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cg_interfaces__srv__GetMap_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cg_interfaces__srv__GetMap_Response * ros_message = static_cast<cg_interfaces__srv__GetMap_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cg_interfaces__srv__GetMap_Response(cdr, ros_message);
}
...
using _GetMap_Event__ros_msg_type = cg_interfaces__srv__GetMap_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_serialize_cg_interfaces__srv__GetMap_Event(
  const cg_interfaces__srv__GetMap_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cg_interfaces__srv__GetMap_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_cg_interfaces__srv__GetMap_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_deserialize_cg_interfaces__srv__GetMap_Event(
  eprosima::fastcdr::Cdr & cdr,
  cg_interfaces__srv__GetMap_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      cg_interfaces__srv__GetMap_Request__Sequence__fini(&ros_message->request);
    }
    if (!cg_interfaces__srv__GetMap_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cg_interfaces__srv__GetMap_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      cg_interfaces__srv__GetMap_Response__Sequence__fini(&ros_message->response);
    }
    if (!cg_interfaces__srv__GetMap_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_cg_interfaces__srv__GetMap_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t get_serialized_size_cg_interfaces__srv__GetMap_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cg_interfaces__srv__GetMap_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cg_interfaces__srv__GetMap_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t max_serialized_size_cg_interfaces__srv__GetMap_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cg_interfaces__srv__GetMap_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cg_interfaces__srv__GetMap_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cg_interfaces__srv__GetMap_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
bool cdr_serialize_key_cg_interfaces__srv__GetMap_Event(
  const cg_interfaces__srv__GetMap_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cg_interfaces__srv__GetMap_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_cg_interfaces__srv__GetMap_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t get_serialized_size_key_cg_interfaces__srv__GetMap_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetMap_Event__ros_msg_type * ros_message = static_cast<const _GetMap_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cg_interfaces__srv__GetMap_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_cg_interfaces__srv__GetMap_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cg_interfaces
size_t max_serialized_size_key_cg_interfaces__srv__GetMap_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cg_interfaces__srv__GetMap_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_cg_interfaces__srv__GetMap_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const cg_interfaces__srv__GetMap_Event * ros_message = static_cast<const cg_interfaces__srv__GetMap_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_cg_interfaces__srv__GetMap_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  cg_interfaces__srv__GetMap_Event * ros_message = static_cast<cg_interfaces__srv__GetMap_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_cg_interfaces__srv__GetMap_Event(cdr, ros_message);
}

static uint32_t _GetMap_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cg_interfaces__srv__GetMap_Event(
      untyped_ros_message, 0));
}
...
static size_t _GetMap_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cg_interfaces__srv__GetMap_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cg_interfaces, srv, GetMap_Event)() {
