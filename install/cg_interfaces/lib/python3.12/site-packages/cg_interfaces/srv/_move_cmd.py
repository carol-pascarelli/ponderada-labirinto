...
class MoveCmd_Response(metaclass=Metaclass_MoveCmd_Response):
    ...
    def __eq__(self, other):
        ...
        if self.success != other.success:
            return False
        if any(self.robot_pos != other.robot_pos):
            return False
...
class Metaclass_MoveCmd_Event(type):
    """Metaclass of message 'MoveCmd_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_cmd__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_cmd__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_cmd__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_cmd__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_cmd__event
...
class MoveCmd_Event(metaclass=Metaclass_MoveCmd_Event):
    """Message class 'MoveCmd_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<cg_interfaces/MoveCmd_Request, 1>',
        'response': 'sequence<cg_interfaces/MoveCmd_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cg_interfaces', 'srv'], 'MoveCmd_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['cg_interfaces', 'srv'], 'MoveCmd_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from cg_interfaces.srv import MoveCmd_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveCmd_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MoveCmd_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from cg_interfaces.srv import MoveCmd_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveCmd_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MoveCmd_Response'"
...
class Metaclass_MoveCmd(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _move_cmd.Metaclass_MoveCmd_Event._TYPE_SUPPORT is None:
                _move_cmd.Metaclass_MoveCmd_Event.__import_type_support__()
...
class MoveCmd(metaclass=Metaclass_MoveCmd):
    ...
    from cg_interfaces.srv._move_cmd import MoveCmd_Event as Event
